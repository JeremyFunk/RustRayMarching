...
pub fn load_scene(path: &str) -> Scene{
    ...
    let camera: Camera = Camera { 
        cam_pos: [convert_animated_float(json.camera.cam_pos[0].to_owned()), convert_animated_float(json.camera.cam_pos[1].to_owned()), convert_animated_float(json.camera.cam_pos[2].to_owned())], 
        cam_py: [convert_offset(json.camera.cam_py[0].to_owned(), 0.0, -1.0), convert_offset(json.camera.cam_py[1].to_owned(), 90.0, -1.0)]
    };
    ...
    for g in json.group_modifiers{
        group_modifiers.push(SceneGroupModifier { prim0: g.prim0, prim1: g.prim1, prim2: g.prim2, prim3: g.prim3, prim_attribute: convert_animated_float(g.prim_attribute), modifier: g.modifier });
    }
    ...
    for o in json.objects{
        ...
        objects.push(SceneObject { 
            position: [convert_animated_float(o.position[0].to_owned()), convert_animated_float(o.position[1].to_owned()), convert_animated_float(o.position[2].to_owned())], 
            rotation: [convert_animated_float(o.rotation[0].to_owned()), convert_animated_float(o.rotation[1].to_owned()), convert_animated_float(o.rotation[2].to_owned())], 
            scale: [convert_animated_float(o.scale[0].to_owned()), convert_animated_float(o.scale[1].to_owned()), convert_animated_float(o.scale[2].to_owned())], 
            prim_type: o.prim_type, 
            values: [
                convert_animated_float(o.values[0].to_owned()), convert_animated_float(o.values[1].to_owned()), convert_animated_float(o.values[2].to_owned()),
                convert_animated_float(o.values[3].to_owned()), convert_animated_float(o.values[4].to_owned()), convert_animated_float(o.values[5].to_owned()),
                convert_animated_float(o.values[6].to_owned()), convert_animated_float(o.values[7].to_owned()), convert_animated_float(o.values[8].to_owned()),
    ...
    let scene = 
    return Scene { objects: objects, group_modifiers: group_modifiers, camera: camera };
}